					...
					<div class="header_right_details">
						<div class="top_row">
							<ul>
								...
								<li class="login"><a href="login-register.php" title="Create new Account">Create Account</a>&nbsp;|&nbsp;<a href="login-register.php" title="Login">Login</a>&nbsp;|&nbsp;<a href="<?=$cfg['base_url_v'].'Instant-order.php'?>">Instant-Pay</a></li>
								<?php } if($_SESSION['userid']!=''){?>
								<li class="login"><a href="my_account.php">My Account</a>&nbsp;|&nbsp;<a href="login_process.php?action=logout">Logout</a>&nbsp;|&nbsp;<a href="<?=$cfg['base_url_v'].'Instant-order.php'?>">Instant-Pay</a></li>
								<?php } ?>
								<li class="follow"><a href="http://www.facebook.com"><div class="fb"></div></a><a href="http://www.twitter.com"><div class="twtr"></div></a></li>
								<li class="need_help">Need Help ? <strong>Call +91-9820561649,  +91-7666609786</strong></li>
								<li class="delivery_car"><img src="images/fast_delivery_icon.png" alt="" /></li>
							</ul>
							<div class="clear"></div>							
						</div>						
						<div class="bottom_row">
							<div class="top_txt">Flower Delivery in more than <span class="brown">350 cities</span> in <span class="brown">India</span></div>
				...
				<div class="menu_body">
					<div class="menu">
						<ul>
						 ...
						 <!--<ul>
							...
							<!--<li><a href="<?=$cfg['base_url_v']?>product.php?category=141#main" onClick="lisTrans(223);"><?="Mother's Day";?></a></li>-->
							<?
					...
					<div id="menulist" class="menu_list" style="display:none;">
						<ul class="topnav">
							...
							<li class="sub_menu"><a href="<?=$cfg['base_url_v']?>product.php?category=223#main"><?="Mother's Day";?></a></li>
							<?
							$sql="SELECT * FROM ".$cfg['DB_CATEGORY']."  WHERE `cat_parent_id`='0' AND `status`='A' AND `show_in_top_menu`='Y' ORDER BY `order`";
							$res=$heart->sql_query($sql);
							$maxrow=$heart->sql_numrows($res);
