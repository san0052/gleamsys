...
<td vAlign=top align="center" width="99%"><!-- Start Body Here -->
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	  ...
	  <? //show all record
	   ...
	   ?>
	    ...
	    <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
          <thead>
            <tr>
              <td colspan="11" align="left">&nbsp;<span class="style2">Manage Brand Logo</span> </td>
            </tr>
          </thead>
          <tbody>
            <? if($_REQUEST['m']){ ?>
		...
		<?php
		 	$sql    = "SELECT * FROM ".$cfg['DB_BRAND_LOGO']." WHERE 
		...
		?>
            <tr class="<?=($i%2==0)?'row1':'row2'?>">
			  ...
			  <td align="center">
				  ...
				  <a href="homePageBrandLogo-process.php?act=edit&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
			  
				  <a href="homePageBrandLogo-process.php?act=del&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/drop.gif" title="Delete" width="16" height="16" border="0" onClick="return confirm('Do you really want to delete this record ?');" /></a>
		...
		<div class="bottomsecc">		
			<a class="brownbttn" href="homePageBrandLogo-process.php?act=add&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">Add Brand Logo</a>
		</div>
	...
	{ 
	?>
		<form name="frmadd" id="frm2" method="post" action="homePageBrandLogo-process.php" onsubmit="return add_typ_value()" enctype="multipart/form-data"><p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            <thead> 
              <tr> 
                <td colspan="5" align="left" class="style2">&nbsp;Add Brand Logo</td> 
              </tr> 
            </thead> 
            <tbody> 
              <?php if($_REQUEST['m']){ ?>
	...
	// show edit window
	  ...
	  ?>
	  <form name="frmedit"  id="frm3" method="post" action="homePageBrandLogo-process.php" enctype='multipart/form-data' onsubmit="return edit_typ_value()">
          <p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            ...
            <tbody> 
              ...
              <tr class="row1"> 
				...
				&nbsp;&nbsp;<img src="../uploads/brand_logo/<?=$row['BrandLogoImage'];?>" width="70" align="top"/></td>
			 </tr> 
				<tr class="row2"> 
