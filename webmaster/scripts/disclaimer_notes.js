	...
	if(document.frm1.dropdown1.value=='delete')
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to delete these records')==true)
		   {   
		   var pageno1=pageno;
		   window.location.href="disclaimer_process.php?act=muldel&id="+ar+"&pageno="+pageno1;
			 return true;
	       }
		   else
		   {
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to activate these records')==true)
		   {   
		   var pageno1=pageno;
		    window.location.href="disclaimer_process.php?act=mulactive&id="+ar+"&pageno="+pageno1;
			 return true;
	       }
		   else
		   {
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to inactivate these records')==true)
		   {   
		 var pageno1=pageno;
		window.location.href="disclaimer_process.php?act=mulinactive&id="+ar+"&pageno="+pageno1;
			 return true;
	       }
		   else
		   {
