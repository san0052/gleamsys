...
if (isset($_GET['success']) && $_GET['success'] == 'true') {
    ...
    try {
        ...
        print_r($payment->getId());
         echo '<pre>getPayar';
        print_r($_GET['PayerID']);
        echo '<pre>shipping';
        print_r($details->getShipping());
        echo "<br>tax 12<pre>";
        print_r($details->getTax());
        echo "<br>currency<pre>";
        print_r($amount->getCurrency());
        echo "<br>get total<pre>";
        print_r($amount->getDetails());
        echo "<br>total<pre>";
        print_r($amount->getTotal());
        echo "<br>payment getPayee<pre>";
        print_r($payment->getPayee());

        echo "<br>payment getCart<pre>";
        print_r($payment->getCart());
         echo "<br>payment getTransactions<pre>";
        print_r($payment->getTransactions());

        echo "<br>createTime<pre>";
        print_r($payment->getCreateTime());
        echo '<br>payment';
        print_r($payment);
         die;
