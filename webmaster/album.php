...
<script language="javascript" src="scripts/album.js"></script>
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr>
	  ...
	  /* $returnCatId=($_REQUEST['catId']=="")?'0':$_REQUEST['catId'];*/
	   ...
	   ?>
              <form name="frm1" id="frm1" action="album_process.php" method="post">
                ...
                <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
                  ...
                  <tbody>
                    ...
                    <tr class="headercontent">
                      ...
                      <td align="left" class="leftBarText_new1" colspan="3">Album</td>
		...
		$sql="SELECT * FROM ".$cfg['DB_ALBUM']."  WHERE 1 ORDER BY `id`";
			...
			?>
                    <tr class="<?=($i%2==0)?'row1':'row2'?>">
                      ...
                      <td align="center"><a href="album_process.php?act=<?=($row['status']=='A')?'Inactive':'Active'?>&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>&secpid=<?=($_REQUEST['secpid']!="")?$_REQUEST['secpid']:'0'?>&pId=<?=($_REQUEST['pId']!="")?$_REQUEST['pId']:'0'?>" class="<?=($row['status']=='A')?'greenbuttonelementsNew':'redbuttonelementsNew'?>">
                        <?=($row['status']=='A')?'Active':'Inactive'?>
                        </a> </td>
                      <td align="center">
						<a href="album.php?show=edit&id=<?=$row['id']?>&pId=<?=$parentId?>&secpid=<?=$secparent?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
						
						<a href="album_process.php?act=del&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>&secpid=<?=($_REQUEST['secpid']!="")?$_REQUEST['secpid']:'0'?>&pId=<?=($_REQUEST['pId']!="")?$_REQUEST['pId']:'0'?>"><img src="images/drop.gif" title="Delete" width="16" height="16" border="0" onClick="return confirm('Do you really want to delete this record');" /></a></td>
                    </tr>
                    <? }
...
?>
                ...
                <div class="bottomsecc">
                  ...
                  <a class="brownbttn" href="album.php?show=add&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&secpid=<?=($_REQUEST['secpid']!="")?$_REQUEST['secpid']:'0'?>&pId=<?=($_REQUEST['pId']!="")?$_REQUEST['pId']:'0'?>">Add New Album</a>
                </div>
              </form>
              <? }
	  ...
	  if($show=='add') { ?>
              <form name="frmadd" id="frm2" method="post" action="album_process.php"  onsubmit="return add_typ_value()">
                <p>
                ...
                <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new">
                  <thead>
                    <tr>
                      <td colspan="5" align="left" class="style2">&nbsp;Add  Album Section </td>
                    </tr>
                  </thead>
                  <tbody>
                    <? if($_REQUEST['m']){ ?>
                    ...
                    <? } ?>
					<tr class="row2">
                      <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Album Name </span> <span class="redstar">*</span></td>
                      <td width="70%" colspan="4" align="left"><input name="cat_name" type="text" class="forminputelement" id="cat_name" onkeyup="album_availability();" onblur="album_availability();" />
                    ...
                    <tr>
                      ...
                      <td colspan="4" align="center">
						<a class="brownbttn" href="album.php?pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&secpid=<?=($_REQUEST['secpid']!="")?$_REQUEST['secpid']:'0'?>&pId=<?=($_REQUEST['pId']!="")?$_REQUEST['pId']:'0'?>">&lt;&lt;back</a>
          ...
          if($show=='edit'){
            ...
            $sql="SELECT * FROM ". $cfg['DB_ALBUM']." WHERE  `id` =".$_REQUEST['id']."";
	  ...
	  ?>
              <form name="frmedit"  id="frm3" method="post" action="album_process.php" onsubmit="return edit_typ_value()">
                <p>
                ...
                <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new">
                  <thead>
                    <tr>
                      <td colspan="5" align="left" class="style2">Edit  Album Section </td>
                    </tr>
                  </thead>
                  <tbody>
                    <? if($_REQUEST['m']){ ?>
                    ...
                    <tr class="row2">
                      <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Album Name </span> <span class="redstar">*</span></td>
                      <td width="70%" colspan="4" align="left"><input name="cat_name" type="text" class="forminputelement" id="cat_name" onkeyup="album_availability();" onblur="album_availability();" value="<?=$row['name']?>" />
                        &nbsp;&nbsp;<span style="display:none;" id="exsists"><img src="images/cross_circle.png"  align="absmiddle" width="16"/>&nbsp;Already exists</span><span style="display:none;" id="notexsists"><img src="images/tick_circle.png" width="16" align="absmiddle" />&nbsp;Ok</span>
                        </div>
                        <? /*//if(countShowinTop() <5){?>
                        <div id="show_in_menu">
                    ...
                    <tr>
                      <td colspan="4" align="center">
						<a class="brownbttn" href="album.php?pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">&lt;&lt;back</a>
						<input type="submit" name="Save" id="Save" value="Save" class="loginbttn">
                      </td>
                    </tr>
                  </tbody>
