...
<td vAlign=top align="center" width="99%"><!-- Start Body Here -->
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	  ...
	  <? //show all record
	   ...
	   ?>
	    ...
	    <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
          <thead>
            <tr>
              <td colspan="11" align="left">&nbsp;<span class="style2">Counter Information</span> </td>
            </tr>
          </thead>
          <tbody>
            <? if($_REQUEST['m']){ ?>
            ...
            <tr class="headercontent">
	             ...
	             <td width="23%" align="center" colspan="3" class="leftBarText_new1">Counter</td>
		...
		<?
		 	$sql    = "SELECT * FROM ".$cfg['DB_HOME_COUNTER']." WHERE 
		...
		?>
            <tr class="<?=($i%2==0)?'row1':'row2'?>">
				...
				<td align="center" colspan="3" >&nbsp;<?=$row['counter'];?></td>		 	  
			  
              	<td align="center">
			  
				  <a href="homeCounter-process.php?act=<?=($row['status']=='A')?'Inactive':'Active'?>&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>" class="<?=($row['status']=='A')?'greenbuttonelementsNew':'redbuttonelementsNew'?>"><?=($row['status']=='A')?'Active':'Inactive'?></a>
			  ...
			  <td align="center">
				  ...
				  <a href="homeCounter-process.php?act=edit&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
			  
				  <a href="homeCounter-process.php?act=del&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/drop.gif" title="Delete" width="16" height="16" border="0" onClick="return confirm('Do you really want to delete this record ?');" /></a>
		...
		<!-- <div class="bottomsecc">		
			<a class="brownbttn" href="homeCounter.php?show=add&pageno=<?//=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">Add New Notes</a>
		</div> -->
			...
			<tr class="row2"> 
				...
				<tr class="row1">
                 <td colspan="2" align="center">
					<textarea name="counter" id="counter" class="forminputelement textareawid" rows="4"></textarea>	
				 </td>
            </tr>
	...
	// show edit window
	  ...
	  ?>
	  <form name="frmedit"  id="frm3" method="post" action="homeCounter-process.php" onsubmit="return edit_typ_value()">
          <p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            ...
            <tbody> 
              ...
              <tr class="row1"> 
				...
				<tr class="row2"> 
	                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Counter</span><span class="redstar">*</span></td> 
	                <td  width="70%" colspan="4" class="leftBarText" align="left" valign="top"><input type="text" name="counter" id="counter" value="<?= $row['counter'];?>"></td>
		  		</tr>
		 		
		   <td align="center" colspan="2">
				<a class="brownbttn" href="homeCounter.php?pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">&lt;&lt;back</a>
				<input type="submit" name="Save" id="Save" value="Save" class="loginbttn">
		   </td> 
