   <div class="floating-box">
     ...
     <a href="https://wa.me/+61 435 074 100">
         ...
         <div class="row">
           ...
           <div class="col-xs-12 col-md-3 footer-link contact-list">
             ...
             <ul>
               ...
               <li style="cursor: not-allowed;"><span class="chk-tick"><i style="transform: rotate(90deg);" class="fas fa-phone"></i></span><?php echo $row['phone1'];?>,<?php echo $row['phone2'];?></li>
                <li style="cursor: not-allowed;"><span class="chk-tick"><i style="transform: rotate(90deg);" class="fas fa-phone"></i></span><?php echo $row['tel'];?></li>
           ...
           <div class="col-xs-12 col-md-3 footer-link">
             ...
             <ul>
               ...
               <p class="des" style="margin-top:30px;">PAYMENT OPTIONS</p>
