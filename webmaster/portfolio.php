  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr>
	  ...
	  <? //show all record
	   ...
	   ?>
	  	 <form name="frm1" id="frm1" action="client.php" method="post">
	    ...
	    <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
          <thead>
            <tr>
              <td colspan="11" align="left">&nbsp;<span class="style2">Manage Portfolio Information</span> </td>
            </tr>
          </thead>
          <tbody>
            <? if($_REQUEST['m']){ ?>
            ...
            <tr class="headercontent">
				<td width="6%" align="center" class="leftBarText_new1"><input name="check_all" id="check_all" class="check-all" type="checkbox" onclick="checkall();"/></td>
          	    ...
          	    <td width="17%" align="center"colspan="3" class="leftBarText_new1">Portfolio Name</td>
		...
		<?php
		 	$sql    = "SELECT * FROM ".$cfg['DB_PORTFOLIO_INFO']." WHERE 
		...
		?>
            <tr class="<?=($i%2==0)?'row1':'row2'?>">
				...
				<td align="center" colspan="2"><?=$row['portfiloName']?></td> 
              	<td align="center" colspan="4" >&nbsp;<img src="../uploads/portfolio_image/<?=$row['portofiloImg'];?>" width="70" align="top"/></td>
				<td align="center" colspan="3" >&nbsp;<?=$row['altTag'];?></td>	

              	<td align="center">
				  <a href="portfoilo-process.php?act=<?=($row['status']=='A')?'Inactive':'Active'?>&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>" class="<?=($row['status']=='A')?'greenbuttonelementsNew':'redbuttonelementsNew'?>"><?=($row['status']=='A')?'Active':'Inactive'?></a>
			  ...
			  <td align="center">
				  ...
				  <a href="portfoilo-process.php?act=edit&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
			  
				  <a href="portfoilo-process.php?act=del&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/drop.gif" title="Delete" width="16" height="16" border="0" onClick="return confirm('Do you really want to delete this record ?');" /></a>
		...
		<div class="bottomsecc">		
			<a class="brownbttn" href="portfoilo-process.php?act=add&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">Add Project Info</a>
		</div>
	...
	{ 
	?>
		<form name="frmadd" id="frm2" method="post" action="portfoilo-process.php" onsubmit="return add_typ_value()" enctype="multipart/form-data"><p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            <thead> 
              <tr> 
                <td colspan="5" align="left" class="style2">&nbsp;Add Portfolio Info</td> 
              </tr> 
            </thead> 
            <tbody> 
              <?php if($_REQUEST['m']){ ?>
              <tr class="row2">
                <td colspan="17" align="left" class="redbuttonelements"><?=@$msg?></td>
             </tr>
			  <? } ?>
			<tr class="row1"> 
                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Portofilo Name</span> <span class="redstar">*</span></td> 
                <td width="70%" colspan="4" align="left"><input name="portfiloName" type="text" class="forminputelement" id="portfiloName" value=""/>&nbsp;&nbsp;</td>
			</tr>

			<tr class="row1"> 
                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Portofile Image</span> <span class="redstar">*</span></td> 
            ...
            <tr> 
                <td align="center" colspan="2">
					<a class="brownbttn" href="client.php?pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">&lt;&lt;back</a>
	...
	// show edit window
	  ...
	  ?>
	  <form name="frmedit"  id="frm3" method="post" action="portfoilo-process.php" enctype='multipart/form-data' onsubmit="return edit_typ_value()">
          <p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            <thead> 
              <tr> 
                <td colspan="5" align="left" class="style2">&nbsp;Edit Project Section </td> 
              </tr> 
            </thead> 
            <tbody> 
              <? if($_REQUEST['m']){ ?>
			  ...
			  <tr class="row2"> 
	                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Portfolio Name</span></td> 
	                <td  width="70%" colspan="4" class="leftBarText" align="left" valign="top">
	                	<input type="text" name="portfiloName" id="portfiloName" value="<?= $row['portfiloName'];?>" style="width:80%"></td>
		  		</tr>

              <tr class="row1"> 
                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Portfolio Image</span> <span class="redstar">*</span></td> 
                <td width="70%" colspan="4" align="left">
				<input name="image" type="file" class="forminputelement" id="image"/>
				&nbsp;&nbsp;<img src="../uploads/portfolio_image/<?=$row['portofiloImg'];?>" width="70" align="top"/></td>
			 </tr>
		   ...
		   <td align="center" colspan="2">
				<a class="brownbttn" href="portfilo.php?pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">&lt;&lt;back</a>
				<input type="submit" name="Save" id="Save" value="Save" class="loginbttn">
		   </td> 
