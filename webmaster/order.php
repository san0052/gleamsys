							...
							//======================================  VIEW RECORD ========================================//
												...
												<tr class="row2">
													...
													<td colspan="2" align="left">	
														...
														<select name="status2" class="forminputelement" id="status2" onchange="delivered_by_form_view(this.id)">
															...
															<option value="OutForDelivery" <?=($status=='OutForDelivery')?'selected="selected"':''?>>OutForDelivery</option>
															<option value="OrderProcessing" <?=($status=='OrderProcessing')?'selected="selected"':''?>>Order Processing</option>
														...
														<form action="order_process.php" method="POST">
															...
															<table width="100%" border="0" cellpadding="6" cellspacing="1">
																<tr>
																	...
																	<td colspan="2" align="left">
																		<textarea class="forminputelement"  name="fed_by" id="fed_by" value="<?=$row['od_feedback']?>"><?=$row['od_feedback']?></textarea>
																		<!-- <input type="text" class="forminputelement"  name="fed_by" id="fed_by" value="<?=$row['od_feedback']?>"> -->
																		<!-- <input class="forminputelement"  type="submit" name="submit" value="submit"> -->
																	</td>
																</tr>
															</table>
														</form>
									...
									<table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
										...
										<tbody>
											<tr class="row1">
												...
												<td align="left" class="leftBarText_new">Preference</td>
											...
											while($row_od =	$heart->sql_fetchrow($res_od))										{
												...
												<tr class="row2">
													...
													<td align="right"><?=pd_preference($row_od['pd_id'])?></td>
											...
											?>
											<tr class="row2">
												<td colspan="5" align="right" class="leftBarText_new">Sub-total</td>
												<td align="right"><?=subTotal($row['od_id'])?></td>
											</tr>
											<tr class="row2">
												<td colspan="5" align="right" valign="top" class="leftBarText_new">Shipping</td>
												<? 
											...
											<tr class="row2">
												<td colspan="5" align="right" valign="top" class="leftBarText_new">Shipping Type</td>
												
												<td align="right" valign="top">
													<?php echo findType($row['od_id']);?>

												</td>
											</tr>
											<tr class="row2">
												<td colspan="5" align="right" valign="top" class="leftBarText_new">Delivery Time</td>
												
												<td  valign="top">
													<?php echo findTime($row['od_id']);?>

												</td>
											</tr>
											<tr class="row2">
												<td colspan="5" align="right" class="leftBarText_new">Total</td>
									...
									<table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
										...
										<tbody>
											...
											<tr>
												<td width="29%" align="left" class="row1">
													<span class="leftBarText_new">Name </span>
												</td>
