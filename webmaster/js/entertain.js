function check_emailadd(email)	{
			...
			if(email!="")
			{
				...
				else
				{
					...
					http.open('get','entertain_process.php?act='+act+'&email='+email);
	  ...
	  function check_emailedit(email,id)	{
			...
			if(email!="")
			{
				...
				else
				{
					...
					http.open('get','entertain_process.php?act='+act+'&email='+email+'&id='+id);
...
function getstate(id)
{
	...
	if(id!="")
	{
		...
		var act='getstate';
		http.open('get','entertain_process.php?act='+act+'&id='+id);
