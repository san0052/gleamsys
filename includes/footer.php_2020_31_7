...
<!-- 
         ...
         <div class="col-xs-12 col-md-3 footer-link contact-list">
           <ul>
             ...
             <li><span class="chk-tick"><i class="fas fa-mobile"></i></span>987456210</li>

             <li><span class="chk-tick"><i class="fas fa-mobile"></i></span>987456210</li>

             <li><span class="chk-tick"><i style="transform: rotate(90deg);" class="fas fa-phone"></i></span>987456210</li>

             <li><span class="chk-tick"><i class="fas fa-envelope"></i></span>info@gleamsys.com</li>
