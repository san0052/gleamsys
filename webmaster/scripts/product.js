...
function product_add(frmadd)
{
	...
	{ //alert('arka');
		...
		var ele1 = frmadd.elements['prod_pname_addon[]'];
		var ele2 = frmadd.elements['prod_price_addon[]'];
		var ele3 = frmadd.elements['prod_locon[]'];
		//var ele4 = frmadd.elements['prod_codeon[]'];
		var ele5 = frmadd.elements['descriptionon[]'];
		var ele6 = frmadd.elements['image_addon[]'];
		//alert(ele.length);
		//return false;
//alert(ele1.length);
var flag=0;
...
/*		if(frmadd.elements['prod_price_addon['+i+']']!='' && document.frmadd.prod_locon[i].value!='' && document.frmadd.prod_codeon[i].value!='' && document.frmadd.descriptionon[i].value!='' && document.frmadd.image_addon[i].value!='')
		{
			alert('arka');
			return true;
		}else{
			
				 if(document.frmadd.prod_pname_addon[i].value=='')
						{
						 alert("Please enter Product Name");
						 document.frmadd.prod_pname_addon[i].focus();
						 return false;
					}
					 if(document.frmadd.prod_price_addon[i].value=='')
						{
						 alert("Please enter Product Price");
						 document.frmadd.prod_price_addon[i].focus();
						 return false;
					}
					 if(document.frmadd.prod_locon[i].value=='')
						{
						 alert("Please enter Product Location");
						 document.frmadd.prod_locon[i].focus();
						 return false;
					}
					 if(document.frmadd.prod_codeon[i].value=='')
						{
						 alert("Please enter Product Code");
						 document.frmadd.prod_codeon[i].focus();
						 return false;
					}
					 if(document.frmadd.descriptionon[i].value=='')
						{
						 alert("Please enter Product Description");
						 document.frmadd.descriptionon[i].focus();
						 return false;
					}
					 if(document.frmadd.image_addon[i].value=='')
						{
						 alert("Please enter Product Image");
						 document.frmadd.image_addon[i].focus();
						 return false;
					}
	}*/
	...
	if(document.frm1.dropdown1.value=='delete')
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to delete these records')==true)
		   {   
		   var pageno1=pageno;
		   window.location.href="product_process.php?act=del&category="+category+"&id="+ar+"&pageno="+pageno1;
			 return true;
	       }
		   else
		   {
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to activate these records')==true)
		   {   
		   var pageno1=pageno;
		   window.location.href="product_process.php?act=Active&category="+category+"&id="+ar+"&pageno="+pageno1;
			 return true;
	       }
		   else
		   {
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to inactivate these records')==true)
		   {   
		 var pageno1=pageno;
		 window.location.href="product_process.php?act=Inactive&category="+category+"&id="+ar+"&pageno="+pageno1;
			 return true;
	       }
		   else
		   {
