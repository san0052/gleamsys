  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	  ...
	  <? //show all record
	   ...
	   ?>
	    ...
	    <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
          <thead>
            <tr>
              <td colspan="11" align="left">&nbsp;<span class="style2">Manage Tech-support Section</span> </td>
            </tr>
          </thead>
          <tbody>
            <?php if($_REQUEST['m']){ ?>
            ...
            <tr class="headercontent">
				 ...
				 <td width="17%" align="center" colspan="3" class="leftBarText_new1">Service Page Name</td>
            	 <td width="17%" align="center" colspan="3" class="leftBarText_new1">Service Title</td>
	             <td width="23%" align="center" colspan="3" class="leftBarText_new1">Description</td>
	             <td width="23%" align="center" colspan="3" class="leftBarText_new1">Subject Name</td>
				 <td width="13%" align="center" class="leftBarText_new1">Status</td> 
				 <td width="15%" align="center" class="leftBarText_new1">Action</td>
            </tr>		  
			
		<?
		 	$sql    = "SELECT * FROM ".$cfg['DB_SERVICE_INFO']." WHERE 
						`siteId`= '".$cfg['SESSION_SITE']."' 
						AND `status` != 'D'
						AND `pageName`= 'tech-support'"; 
			$res    = $heart->sql_query($sql);
		...
		?>
            <tr class="<?=($i%2==0)?'row1':'row2'?>">
				...
				<td align="center">
				  ...
				  <td align="center">
					  ...
					  <a href="service-process.php?act=edit&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
		 ...
		 <!-- <div class="bottomsecc">		
			<a class="brownbttn" href="service-process.php?act=add&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">Add Tech-Support Info</a>
		</div>  -->
	...
	// show edit window
	  ...
	  <form name="frmedit"  id="frm3" method="post" action="service-process.php" onsubmit="return edit_typ_value()">
          <p>
            <input type="hidden" name="act" value="updateTechSupport" />            
