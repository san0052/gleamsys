...
function getsec_category(id)
{
	...
	if(id!= 0)
	{
		...
		http.open('get','category_process.php?act='+act+'&id='+id);
...
function category_availability_edit(prid,secprid)
{
	...
	var url='category_availability.php?pid='+pid+'&id='+id+'&secpid='+secpid;
	http.open('get',url);
	...
	if(document.frm1.dropdown1.value=='delete')
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to delete these records')==true)
		   {   
		   var pageno1=pageno;
		   window.location.href="category_process.php?act=muldel&id="+ar+"&pageno="+pageno1+"&pId="+pId+"&secpid="+secpid;
			 return true;
	       }
		   else
		   {
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to activate these records')==true)
		   {   
		   var pageno1=pageno;
		    window.location.href="category_process.php?act=mulactive&id="+ar+"&pageno="+pageno1+"&pId="+pId+"&secpid="+secpid;
			 return true;
	       }
		   else
		   {
		...
		if(flag > 0)
		 ...
		 if(confirm('Do you want to inactivate these records')==true)
		   {   
		 var pageno1=pageno;
		window.location.href="category_process.php?act=mulinactive&id="+ar+"&pageno="+pageno1+"&pId="+pId+"&secpid="+secpid;
			 return true;
	       }
		   else
		   {
