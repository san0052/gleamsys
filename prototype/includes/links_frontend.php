...
if ($_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']=='localhost:3200') {
	include_once("includes/configure.php");
	include_once("includes/configure.override.php");
	include_once("includes/configure.dir.php");
	include_once("includes/function.php");
	//include_once("authentication-check.php");
	//include_once("frontend.template.php");
	include_once("lib/class.common.php"); 
} else {
	include_once("/home/eve24hrs/public_html/eve/includes/configure.php");
	include_once("/home/eve24hrs/public_html/eve/includes/configure.override.php");
	include_once("/home/eve24hrs/public_html/eve/includes/configure.dir.php");
	include_once("/home/eve24hrs/public_html/eve/includes/function.php");
	//include_once("authentication-check.php");
	//include_once("frontend.template.php");
	include_once("/home/eve24hrs/public_html/eve/lib/class.common.php"); 
}
