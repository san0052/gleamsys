...
page_header($cfg['ADMIN_TITLE']." - Shipping Type Management");
...
<td vAlign=top align="center" width="99%"><!-- Start Body Here -->
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
      ...
      <table width="698" align="center" border="0" cellspacing="0" cellpadding="0" style="background:url(images/welcome_head.jpg) center top no-repeat;">
	   ...
	   ?>
              <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
                <thead>
                  <tr>
                    <td colspan="4" align="left">&nbsp;<span class="style2">Shipping Type Section</span>&nbsp;</td>
                ...
                <form name="frm1" id="frm1" action="shipping_type_process.php" method="post">
                  ...
                  <tbody>
                    ...
                    <tr class="headercontent">
                      ...
                      <td width="8%" align="center" colspan="6" class="leftBarText_new1">Shipping Type </td>
                      <td align="center" colspan="2" class="leftBarText_new1">Amount</td>
    ...
    <?  if($_REQUEST['category']!='')
		...
		{
			$sql="SELECT * FROM ".$cfg['DB_SHIPPING_TYPE']." ORDER BY `id` ASC";
		}
		$res=$heart->sql_query($sql);
		...
		?>
				<tr class="<?=($i%2==0)?'row1':'row2'?>">
				  ...
				  <td align="center" colspan="2" valign="top"><?=$row['amount']?></td>
				  <td align="center" colspan="4" valign="top">
					<a href="shipping_type.php?show=edit&id=<?=$row['id']?>&pageno=<?=$pageno?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
					</td>
	...
	<? } ?>
	  ...
	  if($show=='edit'){
	  		...
	  		$sql1="SELECT * FROM ".$cfg['DB_SHIPPING_TYPE']." WHERE  `id` =".$_REQUEST['id']." ";
			$res1=$heart->sql_query($sql1);
			$row1=$heart->sql_fetchrow($res1);

	  ?>
              <form name="frmedit" method="post" action="shipping_type_process.php" id="frmedit" enctype="multipart/form-data" onsubmit="return product_edit(this)">
                <p>
                ...
                <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new">
                  ...
                  <thead>
                    <tr>
                      <td colspan="5" align="left" class="style2">&nbsp;Edit Shipping Type Charges </td>
                    </tr>
                  </thead>
                  <tbody>
                    <? if($_REQUEST['m']){ ?>
                  ...
                  <tr class="row2">
                    <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Shipping Type</span> <span class="style3">*</span></td>
                    <td width="70%" colspan="4" align="left"><input name="shipping_type" type="text" class="forminputelement" id="shipping_type" value="<?=$row1['name']?>"/></td>
                  </tr>
                   <tr class="row2">
                    <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Amount</span> <span class="style3">*</span></td>
                    <td width="70%" colspan="4" align="left"><input name="amount" type="text" class="forminputelement" id="amount" value="<?=$row1['amount']?>"/></td>
                  </tr>   
                    <tr>
