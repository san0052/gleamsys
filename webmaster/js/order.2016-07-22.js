	...
	function modifyOrderStatus(orderId,cId){
		...
		window.location.href = 'order_process.php?act=modify&oid=' + orderId + '&status=' + status1 + '&status2=' + status2 + '&del_by=' + del_by + '&fed_by=' + fed_by +'&rec_by=' + rec_by + '&c_id='+cId + '&del_time=' +del_time+'&receive_through='+receive_through;
	}
