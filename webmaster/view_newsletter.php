...
{  
	...
	if(flag > 0)
	{
		...
		{ 
			window.location.href="send_mail_process.php?&act=delete&id="+ar+'&pageno='+pageno;
			return true;
	    }
		else
		{
...
<td vAlign=top align="center" width="99%"><!-- Start Body Here -->
  ...
  <?=$_SESSION['admin_user_name']?></span></td>
	  <td  width="56"align="right" valign="middle"><a href="login.php?act=<?=md5("logout")?>"><img src="images/lock.png" title="Logout" width="24" height="24" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>--><?php */?>
		...
		<tr height="16">
            <td colspan="4" style="background-color:#eee8e8;" valign="middle" align="left">&nbsp;</td>
         </tr>
        <tr>
	  ...
	  <? //show all record
	   ...
	   ?>
	    <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
          <thead>
            <tr>
              <td colspan="7" align="left">&nbsp;<span class="style2">Newsletter</span> </td>
              </tr>
          </thead>
          <tbody>
            ...
            <tr class="headercontent">
              ...
              <td width="41%" align="left" class="leftBarText_new1">Name </td>
              <td width="21%" align="center" class="leftBarText_new1">Email Id</td>
		...
		<?  $sql="SELECT * FROM ".$cfg['DB_NEWSLETTER_EMAIL']." WHERE `siteId`='".$cfg['SESSION_SITE']."'";
            ...
            <tr class="<?=($i%2==0)?'row1':'row2'?>">
             ...
             <td align="center"><?=$i+$offset?></td>
              ...
              <td align="center" valign="middle" ><?=$row['email']?></td>
              <td align="center"><!--<a href="send_mail_process.php?act=view&id=<?=$row['id']?>"><img src="images/view.gif" title="View" width="16" height="16" border="0" /></a><a href="newslist_process.php?act=edit&id=<?=$row['newsId']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>--><a href="send_mail_process.php?act=delete&id=<?=$row['id']?>&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0' ?>"><img src="images/drop.gif" title="Delete" width="16" height="16" border="0" / onClick="return confirm('Do you really want to delete this record');"></a></td>
            </tr>
			<? }
			}
			  else {?>
...
<div style="width:90%; text-align:right;">
		...
		<tr >
			<td colspan="5" align="center" class="redbuttonelements">
				<? if($maxrow >0){?>
