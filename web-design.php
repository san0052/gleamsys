            ...
            <div class="row">
                <div class="col-xs-12 service-inner-up" style="border-bottom: 1px solid #0000004f;">
                    <div class="col-xs-12 about-content">
                        ...
                        <br><br>
                        Anyone can design a website but very few can design websites that are able to rank high in the search engines and turn web visitors into customers.</div>
                </div>
            </div>
        </div>
    </div>
