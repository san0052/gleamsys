...
<td vAlign=top align="center" width="99%"><!-- Start Body Here -->
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	   ...
	   ?>
	    ...
	    <table width="98%" align="center" cellpadding="6" cellspacing="1" class="tborder_new">
          ...
          <tbody>
            ...
            <tr class="headercontent">
	            ...
	            <td width="23%" align="center" colspan="3" class="leftBarText_new1">Banner Button</td>
				<td width="13%" align="center" class="leftBarText_new1">Status</td> 
				<td width="15%" align="center" class="leftBarText_new1">Action</td>
            </tr>		  
			
		<?php
		 	$sql    = "SELECT * FROM ".$cfg['DB_HOME_BANNER']." WHERE 
		...
		?>
            <tr class="<?=($i%2==0)?'row1':'row2'?>">
				...
				<td align="center" colspan="2"><?=$row['bannerTitle']?></td> 
			  
              	<td align="center" colspan="4" >&nbsp;<img src="../uploads/banner_img/<?=$row['bannerImg'];?>" width="70" align="top"/></td>
				<td align="center" colspan="3" >&nbsp;<?=$row['altTag'];?></td>	
				<td align="center" colspan="3" >&nbsp;<?=$row['bannerButton'];?></td>		 	  
              	<td align="center">
			  
				  <a href="homeBanner-process.php?act=<?=($row['status']=='A')?'Inactive':'Active'?>&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>" class="<?=($row['status']=='A')?'greenbuttonelementsNew':'redbuttonelementsNew'?>"><?=($row['status']=='A')?'Active':'Inactive'?></a>
			  ...
			  <td align="center">
				  ...
				  <a href="homeBanner-process.php?act=edit&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a>
			  
				  <a href="homeBanner-process.php?act=del&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>&id=<?=$row['id']?>"><img src="images/drop.gif" title="Delete" width="16" height="16" border="0" onClick="return confirm('Do you really want to delete this record ?');" /></a>
		...
		<div class="bottomsecc">		
			<a class="brownbttn" href="homeBanner-process.php?act=add&pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">Add Banner</a>
		</div>
	...
	{ 
	?>
		<form name="frmadd" id="frm2" method="post" action="homeBanner-process.php" onsubmit="return add_typ_value()" enctype="multipart/form-data"><p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            ...
            <tbody> 
			  ...
			  <? } ?>
			<tr class="row1"> 
                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Banner Title</span> <span class="redstar">*</span></td> 
			...
			<tr class="row1"> 
                <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Banner Button Name</span> <span class="redstar">*</span></td> 
                <td width="70%" colspan="4" align="left"><input name="bannerButton" type="text" class="forminputelement" id="bannerButton" value=""/>&nbsp;&nbsp;</td>
			</tr>	
			      
            <tr> 
                <td align="center" colspan="2">
					<a class="brownbttn" href="homeBanner.php?pageno=<?=($_REQUEST['pageno']!="")?$_REQUEST['pageno']:'0'?>">&lt;&lt;back</a>
	...
	// show edit window
	  ...
	  ?>
	  <form name="frmedit"  id="frm3" method="post" action="homeBanner-process.php" enctype='multipart/form-data' onsubmit="return edit_typ_value()">
          <p>
          ...
          <table width="98%" align="center" cellPadding=6 cellSpacing=1 class="tborder_new"> 
            ...
            <tbody> 
              ...
              <tr class="row1"> 
				...
				&nbsp;&nbsp;<img src="../uploads/banner_Img/<?=$row['bannerImg'];?>" width="70" align="top"/></td>
			 </tr>
			...
			<tr class="row2"> 
	            <td width="30%" align="left" class="leftBarText"><span class="leftBarText_new">Banner Button Name</span></td> 
	            <td  width="70%" colspan="4" class="leftBarText" align="left" valign="top"><input type="text" name="bannerButton" id="bannerButton" value="<?= $row['bannerButton'];?>"></td>
		  	</tr>
