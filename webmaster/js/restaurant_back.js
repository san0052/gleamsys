function check_emailadd(email)	{
			...
			if(email!="")
			{
				...
				else
				{
					...
					http.open('get','restaurant_process.php?act='+act+'&email='+email);
	  ...
	  function check_emailedit(email,id)	{
			...
			if(email!="")
			{
				...
				else
				{
					...
					http.open('get','restaurant_process.php?act='+act+'&email='+email+'&id='+id);
...
function add_val()
{
	...
	{
		alert("Please enter restaurant's name");
	...
	if(document.getElementById("cuisinetype_add").value=="")
	{
		alert("Please enter cuisine type");
		document.getElementById("cuisinetype_add").focus();
		return false;
	}
	
	if(document.getElementById("meal").checked=="false" && document.getElementById("discount").checked=="false")
	{
...
function val_edit()
{
	...
	if(document.getElementById("cuisinetype_edit").value=="")
	{
		alert("Please enter cuisine type");
		document.getElementById("cuisinetype_edit").focus();
		return false;
	}
	if(document.getElementById("cuisinetype_edit").value=="")
	{
...
function getstate(id)
{
	...
	if(id!="")
	{
		...
		var act='getstate';
		http.open('get','restaurant_process.php?act='+act+'&id='+id);
