function check_emailadd(email)	{
			...
			if(email!="")
			{
				...
				else
				{
					...
					http.open('get','corporate_process.php?act='+act+'&email='+email);
	  ...
	  function check_emailedit(email,id)	{
			...
			if(email!="")
			{
				...
				else
				{
					...
					http.open('get','corporate_process.php?act='+act+'&email='+email+'&id='+id);
...
function cust_val_edit()
{
	...
	if(document.getElementById("cust_fname_edit").value=="")
	{
		alert("Please enter first name");
		document.getElementById("cust_fname_edit").focus();
		return false;
	}
	if(document.getElementById("cust_lname_edit").value=="")
	{
		alert("Please enter last name");
		document.getElementById("cust_lname_edit").focus();
		return false;
	}
	...
	if(document.getElementById("cust_pin_edit").value=="")
	{
		alert("Please enter pincode");
		document.getElementById("cust_pin_edit").focus();
		return false;
	}
	
	//Billing
	if(document.getElementById("bill_fname_edit").value=="")
	{
		alert("Please enter first name");
		document.getElementById("bill_fname_edit").focus();
		return false;
	}
	if(document.getElementById("bill_lname_edit").value=="")
	{
		alert("Please enter last name");
		document.getElementById("bill_lname_edit").focus();
		return false;
	}
	if(document.getElementById("bill_addr_edit").value=="")
	{
		alert("Please enter address");
		document.getElementById("bill_addr_edit").focus();
		return false;
	}
	if(document.getElementById("bill_phone_edit").value=="")
	{
		alert("Please enter phone no");
		document.getElementById("bill_phone_edit").focus();
		return false;
	}
	if(document.getElementById("bill_phone_edit").value!="")
	{
		if(isNaN(document.getElementById("bill_phone_edit").value))
		{
			alert("Phone number should be numeric");
			document.getElementById("bill_phone_edit").focus();
			return false;
	...
	if(document.getElementById("bill_country_edit").value=="")
	{
		alert("Please select country");
		document.getElementById("bill_country_edit").focus();
		return false;
	}
	if(document.getElementById("bill_state_edit").value=="")
	{
		alert("Please select state");
		document.getElementById("bill_state_edit").focus();
		return false;
	}
	if(document.getElementById("bill_city_edit").value=="")
	{
		alert("Please select city name");
		document.getElementById("bill_city_edit").focus();
		return false;
	}
	if(document.getElementById("bill_pin_edit").value=="")
	{
		alert("Please enter pincode");
		document.getElementById("bill_pin_edit").focus();
		return false;
	}
	
	//Shipping
	if(document.getElementById("shipp_fname_edit").value=="")
	{
		alert("Please enter first name");
		document.getElementById("shipp_fname_edit").focus();
		return false;
	}
	if(document.getElementById("shipp_lname_edit").value=="")
	{
		alert("Please enter last name");
		document.getElementById("shipp_lname_edit").focus();
		return false;
	}
	...
	if(document.getElementById("shipp_pin_edit").value=="")
	{
		alert("Please enter pincode");
		document.getElementById("shipp_pin_edit").focus();
		return false;
	}
...
function add_cust_val()
{
	...
	if(document.getElementById("bill_city_add").value=="")
	{
		alert("Please select city name");
...
function fill_same()
	{
		...
		{
			document.getElementById("shipp_salutation_add").value=document.getElementById("bill_salutation_add").value;
			...
			setTimeout("call_city()",800);
			setTimeout("fill_city()",1200);
			//document.getElementById("shipp_state_add").value=document.getElementById("bill_state_add").value;
			//document.getElementById("shipp_city_add").value=document.getElementById("bill_city_add").value;
	...
	function fill_sameedit()
	{
		...
		{
			document.getElementById("shipp_salutation_edit").value=document.getElementById("bill_salutation_edit").value;
			...
			getstate_edit3(document.getElementById("bill_country_edit").value);	
			setTimeout("fill_state1()",800);
			setTimeout("call_city1()",1000);
			//getcity_edit3(document.getElementById("bill_state_edit").value);
			setTimeout("fill_city1()",1600);
			//document.getElementById("shipp_city_edit").value=document.getElementById("bill_city_edit").value;
			//document.getElementById("shipp_state_edit").value=document.getElementById("bill_state_edit").value;
	...
	function getstate_cust(id)
{
	...
	if(id!="")
	{
		...
		http.open('get','corporate_process.php?act='+act+'&id='+id);
